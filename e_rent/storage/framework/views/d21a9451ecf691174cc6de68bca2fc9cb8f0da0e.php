    ...
    <main class="limitContainer">
        ...
        <div class="containerProperty">
            ...
            <div class="cardInformation">
                <div class="data">
                    <li class="address"><?php echo e($imovel[0]->cidade); ?></li>
                    <li class="address"><?php echo e($imovel[0]->estado); ?></li>
                    <li class="address"><?php echo e($imovel[0]->rua); ?></li>
                    <li class="address"><?php echo e($imovel[0]->bairro); ?></li>

                    <div class="bottomCard">
                        <li class="price"><?php echo e($imovel[0]->valor); ?></li>
                    </div>    
                </div>
...
</html><?php /**PATH C:\Users\Yuril\OneDrive\Documentos\GitHub\Imobiliario\e_rent\resources\views/property_description/property.blade.php ENDPATH**/ ?>